...
export default function App() {
  return (
    <View style={styles.container}>
      <Text style={styles.content}>Hello World!12ddd</Text>
      {/* 跳转详情页
      ...
      */}
      ...
      <Text onPress={() => router.navigate('/detail')}>GO Detail - router</Text>
      ...
      {/* 2）router传参数 */}
      <Text onPress={() => router.navigate('/details/789')}>GO Detail with id - 789</Text>
      ...
      {/* 模态页面 */}
      <Link href="/teachers/123" style={{ color: 'blue', fontSize: 30 }} asChild>
        <Text>go to Teacher with id</Text>
      </Link>
    </View>
  );
}
